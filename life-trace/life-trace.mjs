...
function renderPortrait(person) {
  ...
  return '<figure class="portrait-card"><img src="' + escapeHtml(person.portrait.src) + '" alt="' + escapeHtml(alt) + '" width="1254" height="1254" decoding="async"></figure>';
}
...
<body>
  <main class="shell" data-theme="light">
    ...
    <aside>
      ...
      <div class="timeline">${renderPortrait(data.person)}${renderCards(data.events)}</div>
